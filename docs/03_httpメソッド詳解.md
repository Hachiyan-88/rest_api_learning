...
<strong>NOTE</strong>
💡 判断のコツ<br>
新しく作る → <strong>POST</strong><br>
既存を指定して更新 → <strong>PUT</strong>
</div>
...
※ PATCHが△なのは、更新内容によって結果が変わる可能性があるため。

例：

- 「年齢を30に変更」 → 何回送っても同じ結果（冪等）
- 「ポイントを+10する」 → 送るたび増える（冪等ではない）
